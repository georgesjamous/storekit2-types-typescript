export enum StoreKit2NotificationType {
   ...
   * and the user receives a prorated refund for the unused portion of the previous period.
   * If the subtype is DOWNGRADE, the user downgraded or cross-graded their subscription.
   * Downgrades take effect at the next renewal. The currently active plan isn’t affected.
   ...
   * If the subtype is DOWNGRADE, the user redeemed an offer to downgrade their active subscription that goes
   * into effect at the next renewal date. If the user redeemed an offer for their active subscription,
   ...
   * The originalTransactionId and productId identify the original transaction and product.
   ...
   * Your app also receives a [paymentQueue(_:didRevokeEntitlementsForProductIdentifiers:)](https://developer.apple.com/documentation/storekit/skpaymenttransactionobserver/3564804-paymentqueue) call.
